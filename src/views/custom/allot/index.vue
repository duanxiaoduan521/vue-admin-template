<template>
  <div class="app-container">
    <div class="filter-container">
      <!-- 搜索条件 -->
      <el-select v-model="getdataListParm.parammaps.applyPasture" clearable placeholder="申请牧场" class="filter-item">
        <el-option
      ...
      <el-select v-model="getdataListParm.parammaps.allotPasture" clearable placeholder="调拨牧场" class="filter-item">
        <el-option
          v-for="item in findAllPasture"
          :key="item.id"
          :label="item.name"
    ...
    >
      <!-- table表格 -->
      <el-table-column label="调拨单号" min-width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.listNumber }}</span>
        </template>
      </el-table-column>
      <el-table-column label="备件编号" prop="id" sortable="custom" align="center" width="150">
        <template slot-scope="scope">
          <span>{{ scope.row.stockNumber }}</span>
        </template>
      </el-table-column>
      <el-table-column label="备件名称" width="150px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="申请牧场" min-width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.applyPasture }}</span>
        </template>
      </el-table-column>
      <el-table-column label="调拨牧场" min-width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.allotPasture }}</span>
        </template>
      </el-table-column>
      <el-table-column label="状态审核" min-width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.statue }}</span>
        </template>
      </el-table-column>
      <el-table-column label="申请时间" min-width="110px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="申请数量" min-width="110px" align="center">
        <template slot-scope="scope">
