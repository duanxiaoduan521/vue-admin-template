<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="沼气表编号" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.methaneNumber }}</span>
        </template>
      </el-table-column>
      <el-table-column label="沼气表名称" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.methaneName }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="当天用气量" min-width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.methaneConsumption }}</span>
        </template>
      </el-table-column>
