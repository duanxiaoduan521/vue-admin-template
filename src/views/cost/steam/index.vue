<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="蒸汽表信息" width="300px" align="center">
        <template slot-scope="scope">
          <span style="float:left;"><span style="font-weight:bold;">编号/名称：</span>{{ scope.row.steamNumber }}&#12288;&#12288;{{ scope.row.steamName }}</span><br>
      ...
      <el-table-column label="使用量(m³)" width="190px" align="center">
        <template slot-scope="scope">
          ...
          <span style="float:left;"><span style="font-weight:bold;">当天用气量：</span>{{ scope.row.steamConsumption }}</span><br>
        </template>
      </el-table-column>
